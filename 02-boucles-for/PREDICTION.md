...
- **Ligne 7 :** Affichage
  ```
  [Écris ce qui sera affiché : i = 1 , somme = 1]
...
- **Ligne 7 :** Affichage
  ```
  [Écris ce qui sera affiché : i = 2 , somme = 3]
  ```
...
- **Ligne 7 :** Affichage
  ```
  [Écris ce qui sera affiché : i = 3 , somme = 6]
  ```
...
- **Ligne 7 :** Affichage
  ```
  [Écris ce qui sera affiché : i = 4 , somme = 10]
  ```
...
- **Ligne 7 :** Affichage
  ```
  [Écris ce qui sera affiché : i = 5 , somme = 15]
  ```
...
```
[Écris ce qui sera affiché : Résultat final : 15]
```
